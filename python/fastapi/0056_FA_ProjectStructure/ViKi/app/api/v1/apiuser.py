...
from repositories.user_repo import repo_create_user,repo_get_user_by_userId  # Import UserRepo for database operations
...
# get user by id
# you can pass user id as query parameter
# /getuserbyid?id=1
